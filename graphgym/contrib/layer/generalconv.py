...
class GeneralEdgeConvLayer(MessagePassing):
    ...
    def __init__(self,
        ...
        if self.msg_direction == 'single':
            self.linear_msg = nn.Linear(in_channels + 1,
                                        out_channels,
                                        bias=False)
        else:
...
class ModGeneralEdgeConvLayer(MessagePassing):
    r"""General GNN layer, with edge features
    """
    def __init__(self,
                 in_channels,
                 ...
                 bias=True,
                 **kwargs):
        super(ModGeneralEdgeConvLayer, self).__init__(aggr=cfg.gnn.agg,
                                                      **kwargs)
